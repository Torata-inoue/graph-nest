...
const getDefaultType = (getValues: UseFormGetValues<TaskInputType>): 1 | 2 | 3 | undefined => {
...
const DueTime: React.FC<TaskPanesProps> = ({
  ...
  const [currentType, setCurrentType] = useState<1 | 2 | 3 | undefined>(getDefaultType(getValues));
